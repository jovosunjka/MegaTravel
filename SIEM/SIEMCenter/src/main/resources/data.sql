...
INSERT INTO `role` (`id`,`role_name`) VALUES (1, 'SECURE_ADMINISTRATOR');
INSERT INTO `role` (`id`,`role_name`) VALUES (2, 'ADMINISTRATOR');
INSERT INTO `role` (`id`,`role_name`) VALUES (3, 'OPERATER');
...
INSERT INTO `permission` (`id`,`permission_name`) VALUES (3, 'CERTIFICATE_SIGNING_REQUEST');
INSERT INTO `permission` (`id`,`permission_name`) VALUES (4, 'REVOKE_CERTIFICATE');
INSERT INTO `permission` (`id`,`permission_name`) VALUES (5, 'READ_LOG');
INSERT INTO `permission` (`id`,`permission_name`) VALUES (6, 'WRITE_LOG');
INSERT INTO `permission` (`id`,`permission_name`) VALUES (7, 'READ_ALARM');
INSERT INTO `permission` (`id`,`permission_name`) VALUES (8, 'ADD_ROLE_TO_USER');
INSERT INTO `permission` (`id`,`permission_name`) VALUES (9, 'ADD_PERMISSION_TO_ROLE');
INSERT INTO `permission` (`id`,`permission_name`) VALUES (10, 'ADD_ROLE_AND_PERMISSION');
INSERT INTO `permission` (`id`,`permission_name`) VALUES (11, 'READ_ROLES_AND_PERMISSIONS');
INSERT INTO `permission` (`id`,`permission_name`) VALUES (12, 'CREATE_ADMINISTRATOR');
INSERT INTO `permission` (`id`,`permission_name`) VALUES (13, 'CREATE_RULE');
INSERT INTO `permission` (`id`,`permission_name`) VALUES (14, 'WRITE_TRUST_STORE');
INSERT INTO `permission` (`id`,`permission_name`) VALUES (15, 'READ_TRUST_STORE');
